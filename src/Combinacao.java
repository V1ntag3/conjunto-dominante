...
public class Combinacao {
	...
	/**
	 * se r e' zero entao iremos fazer todas as combinacoes (com qualquer quantidade
	 * de elementos).
	 */
	public Combinacao(int[] entrada, int r) {
		this.r = r;
		this.entrada = entrada;
		// operador unário que obtém o complemento dos bits, ou seja, inverte todos os
		// bits
		// operadores de deslocamento aritmético para esquerda
	...
	/**
	 * Util para obter o tamanho da saida. Esse tamanho e' o numero de posicoes do
